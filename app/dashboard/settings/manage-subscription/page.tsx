...
export default function ManageSubscriptionPage() {
  ...
  // --- PLANS CONFIGURATION (Merged Design + Data) ---
  const plans = [
    {
      id: 'free',
      name: 'Free Forever',
    ...
    {
      id: 'pro', // ID matches your old code (Price: 5)
      name: 'Pro Hunter',
      price: 5,
      popular: true,
    ...
    {
      id: 'ultra', // ID matches your old code (Price: 10)
      name: 'Maximum Power',
      price: 10,
  ...
  try {
    ...
    // FIX: Use the URL directly from the backend
    if (res.data.url) {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white p-6 md:p-12 animate-in fade-in zoom-in duration-500 relative">
      ...
      {/* CHECKOUT MODAL (Styled to match Cyberpunk Theme) */}
